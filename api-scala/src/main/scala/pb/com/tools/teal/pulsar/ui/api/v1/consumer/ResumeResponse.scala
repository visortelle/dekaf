...
final case class ResumeResponse(
    ...
    consumerStats: _root_.scala.Option[com.tools.teal.pulsar.ui.api.v1.consumer.ConsumerStats] = _root_.scala.None,
    ...
    private[this] def __computeSerializedSize(): _root_.scala.Int = {
      ...
      if (consumerStats.isDefined) {
        val __value = consumerStats.get
        __size += 1 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.serializedSize) + __value.serializedSize
      };
    ...
    def clearStatus: ResumeResponse = copy(status = _root_.scala.None)
    def withStatus(__v: com.google.rpc.status.Status): ResumeResponse = copy(status = Option(__v))
    ...
    def getConsumerStats: com.tools.teal.pulsar.ui.api.v1.consumer.ConsumerStats = consumerStats.getOrElse(com.tools.teal.pulsar.ui.api.v1.consumer.ConsumerStats.defaultInstance)
    def clearConsumerStats: ResumeResponse = copy(consumerStats = _root_.scala.None)
    def withConsumerStats(__v: com.tools.teal.pulsar.ui.api.v1.consumer.ConsumerStats): ResumeResponse = copy(consumerStats = Option(__v))
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => consumerStats.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
      }
    }
...
object ResumeResponse extends scalapb.GeneratedMessageCompanion[com.tools.teal.pulsar.ui.api.v1.consumer.ResumeResponse] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.tools.teal.pulsar.ui.api.v1.consumer.ResumeResponse = {
    ...
    var __consumerStats: _root_.scala.Option[com.tools.teal.pulsar.ui.api.v1.consumer.ConsumerStats] = _root_.scala.None
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 34 =>
          __consumerStats = Option(__consumerStats.fold(_root_.scalapb.LiteParser.readMessage[com.tools.teal.pulsar.ui.api.v1.consumer.ConsumerStats](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.tools.teal.pulsar.ui.api.v1.consumer.ResumeResponse] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.tools.teal.pulsar.ui.api.v1.consumer.ResumeResponse(
        ...
        consumerStats = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).flatMap(_.as[_root_.scala.Option[com.tools.teal.pulsar.ui.api.v1.consumer.ConsumerStats]])
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      ...
      case 4 => __out = com.tools.teal.pulsar.ui.api.v1.consumer.ConsumerStats
    }
    __out
  }
  ...
  lazy val defaultInstance = com.tools.teal.pulsar.ui.api.v1.consumer.ResumeResponse(
    ...
    consumerStats = _root_.scala.None
  )
  implicit class ResumeResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.tools.teal.pulsar.ui.api.v1.consumer.ResumeResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.tools.teal.pulsar.ui.api.v1.consumer.ResumeResponse](_l) {
    ...
    def consumerStats: _root_.scalapb.lenses.Lens[UpperPB, com.tools.teal.pulsar.ui.api.v1.consumer.ConsumerStats] = field(_.getConsumerStats)((c_, f_) => c_.copy(consumerStats = Option(f_)))
    def optionalConsumerStats: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[com.tools.teal.pulsar.ui.api.v1.consumer.ConsumerStats]] = field(_.consumerStats)((c_, f_) => c_.copy(consumerStats = f_))
  }
  final val STATUS_FIELD_NUMBER = 1
  final val MESSAGES_FIELD_NUMBER = 2
  final val PROCESSED_MESSAGES_FIELD_NUMBER = 3
  final val CONSUMER_STATS_FIELD_NUMBER = 4
  def of(
    ...
    consumerStats: _root_.scala.Option[com.tools.teal.pulsar.ui.api.v1.consumer.ConsumerStats]
