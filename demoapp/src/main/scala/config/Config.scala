...
case class ProducerLoadMultipliersConfig(
    ...
    @describe(
        "Multiplier for producers for topics with the highest amount of messages/s. If not set, will be set to 1.0"
    )
...
case class TopicSubscriptionAmountConfig(
    @describe(
        "Amount of subscriptions for topic category with the highest amount of messages/s. If not set, will be random in range [1, 5]"
    )
    overloaded: Option[Int],
    @describe(
        "Amount of subscriptions for topic category with the high amount of messages/s. If not set, will be random in range [1, 5]"
    )
    heavilyLoaded: Option[Int],
    @describe(
        "Amount of subscriptions for topic category with the moderate amount of messages/s. If not set, will be random in range [1, 5]"
    )
    moderatelyLoaded: Option[Int],
    @describe(
        "Amount of subscriptions for topic category with the low amount of messages/s. If not set, will be random in range [1, 5]"
    )
...
case class TopicConsumersAmountConfig(
    @describe(
        "Amount of consumers for subscriptions for topic category with the highest amount of messages/s. If not set, will be random in range [1, 10]"
    )
    overloaded: Option[Int],
    @describe(
        "Amount of consumers for subscriptions for topic category with the high amount of messages/s. If not set, will be random in range [1, 10]"
    )
    heavilyLoaded: Option[Int],
    @describe(
        "Amount of consumers for subscriptions for topic category with the moderate amount of messages/s. If not set, will be random in range [1, 10]"
    )
    moderatelyLoaded: Option[Int],
    @describe(
        "Amount of consumers for subscriptions for topic category with the low amount of messages/s. If not set, will be random in range [1, 10]"
    )
    lightlyLoaded: Option[Int]
)
...
case class TopicProducersAmountConfig(
    @describe(
        "Amount of producers for topic category with the highest amount of messages/s. If not set, will be always 1"
    )
    overloaded: Option[Int],
    @describe("Amount of producers for topic category with the high amount of messages/s. If not set, will be always 1")
    heavilyLoaded: Option[Int],
    @describe(
        "Amount of producers for topic category with the moderate amount of messages/s. If not set, will be always 1"
    )
    moderatelyLoaded: Option[Int],
...
case class DemoAppConfig(
    ...
    @describe("""Set the amount of subscriptions for different topic categories.
    ...
    @describe("""Set the amount of consumers for subscriptions for different topic categories.
  ...
  producersAmount: Option[TopicProducersAmountConfig],*/
    @describe(
        "Set the amount of workers (which is a consumer-producer pair). If not set, will be random in range [1, 10]"
    )
...
case class Config(
    ...
    @describe("""Config to manipulate the demo app.
