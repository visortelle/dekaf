...
import demo.tenants.schemas.namespaces.exampleShop.shared.Dto.Address
import demo.tenants.schemas.namespaces.exampleShop.shared.{Event, Randomizable, Schemable}
...
case class AccountCreated(accountId: UUID, firstName: String, lastName: String, email: String, status: String, version: Long) extends Event
...
object PrimaryBillingAddressRemoved extends Randomizable[PrimaryBillingAddressRemoved] with Schemable[PrimaryBillingAddressRemoved]:
...
object PrimaryShippingAddressRemoved extends Randomizable[PrimaryShippingAddressRemoved] with Schemable[PrimaryShippingAddressRemoved]:
