                ...
                .map(_ =>
                    List(
                        TopicPlanGenerator.make(
                            ...
                            mkProducerGenerator = _ =>
                                ProducerPlanGenerator.make(
                                    mkMessage = _ => _ => Message(int32ToBytes(0)),
                        ...
                        TopicPlanGenerator.make(
                            ...
                            mkProducerGenerator = _ =>
                                ProducerPlanGenerator.make(
                                    mkMessage = _ => messageIndex => Message(int32ToBytes(messageIndex.toInt)),
                                    mkSchedule = _ => Schedule.fixed(Duration.fromMillis(10))
                                ),
                            mkSchemaInfos = mkSchemaInfos
                        ),
                            ...
                            mkProducerGenerator = _ =>
                                ProducerPlanGenerator.make(
                                    mkMessage = _ =>
                                        _ =>
                                            Message(
                                                int32ToBytes(faker.number().numberBetween(Int.MinValue, Int.MaxValue))
                                            ),
                                    mkSchedule = _ => Schedule.fixed(Duration.fromMillis(10))
                                ),
                            mkSchemaInfos = mkSchemaInfos
        ...
        val topicPlanGenerators =
            List(
                ...
                TopicPlanGenerator.make(
                    ...
                    mkProducerGenerator = _ =>
                        ProducerPlanGenerator.make(
                            mkMessage = _ => _ => Message(int32ToBytes(Int.MaxValue))
                        ),
                    mkSchemaInfos = mkSchemaInfos
                ),
                TopicPlanGenerator.make(
                    ...
                    mkProducerGenerator = _ =>
                        ProducerPlanGenerator.make(
                            mkMessage = _ => _ => Message(int32ToBytes(Int.MinValue))
                        ),
                    mkSchemaInfos = mkSchemaInfos
                ),
                TopicPlanGenerator.make(
                ...
                TopicPlanGenerator.make(
                    ...
                    mkProducerGenerator = _ =>
                        ProducerPlanGenerator.make(
                            mkMessage = _ =>
                                _ => Message(int32ToBytes(faker.number().numberBetween(Int.MinValue, Int.MaxValue)))
                        ),
                    mkSchemaInfos = mkSchemaInfos
                )
            ) ++ getHighLoadTopics
