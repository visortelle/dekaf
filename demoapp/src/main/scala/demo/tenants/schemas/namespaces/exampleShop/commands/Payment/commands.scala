package demo.tenants.schemas.namespaces.exampleShop.commands.Payment

import demo.tenants.schemas.namespaces.exampleShop.shared.Dto.{Address, CartItem, Money, PaymentMethod}
...
case class RequestPayment(orderId: UUID, amountDue: Money, billingAddress: Address, paymentMethods: Seq[PaymentMethod]) extends Command
...
object DenyPaymentMethodCancellation extends Randomizable[DenyPaymentMethodCancellation] with Schemable[DenyPaymentMethodCancellation]:
