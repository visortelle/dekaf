                    ...
                    List(
                        ...
                        TopicPlanGenerator.make(
                            ...
                            mkProducerGenerator = _ =>
                                ProducerPlanGenerator.make(
                                    mkMessage =
                                        _ => messageIndex => Message(float64ToBytes(messageIndex.toDouble / 1000)),
                                    mkSchedule = _ => Schedule.fixed(Duration.fromMillis(10))
                                ),
                            mkSchemaInfos = mkSchemaInfos
                        ),
                        TopicPlanGenerator.make(
                            ...
                            mkProducerGenerator = _ =>
                                ProducerPlanGenerator.make(
                                    mkMessage = _ => _ => Message(float64ToBytes(faker.random().nextFloat())),
                                    mkSchedule = _ => Schedule.fixed(Duration.fromMillis(10))
                                ),
                            mkSchemaInfos = mkSchemaInfos
                        )
        ...
        val topicPlanGenerators =
            List(
                ...
                TopicPlanGenerator.make(
                    ...
                    mkProducerGenerator = _ =>
                        ProducerPlanGenerator.make(
                            mkMessage = _ => messageIndex => Message(float64ToBytes(messageIndex.toDouble / 1000))
                        ),
                    mkSchemaInfos = mkSchemaInfos
                ),
                TopicPlanGenerator.make(
