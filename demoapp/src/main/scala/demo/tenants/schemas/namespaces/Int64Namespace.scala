                ...
                .map(_ =>
                    List(
                        TopicPlanGenerator.make(
                            ...
                            mkProducerGenerator = _ =>
                                ProducerPlanGenerator.make(
                                    mkMessage = _ => _ => Message(int64ToBytes(0)),
                        ...
                        TopicPlanGenerator.make(
                            ...
                            mkProducerGenerator = _ =>
                                ProducerPlanGenerator.make(
                                    mkMessage = _ => messageIndex => Message(int64ToBytes(messageIndex)),
                                    mkSchedule = _ => Schedule.fixed(Duration.fromMillis(10))
                                ),
                            mkSchemaInfos = mkSchemaInfos
                        ),
                        TopicPlanGenerator.make(
                            ...
                            mkProducerGenerator = _ =>
                                ProducerPlanGenerator.make(
                                    mkMessage = _ =>
                                        _ => Message(int64ToBytes(faker.random.nextLong(Long.MinValue, Long.MaxValue))),
                                    mkSchedule = _ => Schedule.fixed(Duration.fromMillis(10))
                                ),
                            mkSchemaInfos = mkSchemaInfos
                        )
        ...
        val topicPlanGenerators =
            List(
                ...
                TopicPlanGenerator.make(
                    ...
                    mkProducerGenerator = _ =>
                        ProducerPlanGenerator.make(
                            mkMessage = _ => _ => Message(int64ToBytes(Long.MaxValue))
                        ),
                    mkSchemaInfos = mkSchemaInfos
                ),
                TopicPlanGenerator.make(
                    ...
                    mkProducerGenerator = _ =>
                        ProducerPlanGenerator.make(
                            mkMessage = _ => _ => Message(int64ToBytes(Long.MinValue))
                        ),
                    mkSchemaInfos = mkSchemaInfos
                ),
                TopicPlanGenerator.make(
                ...
                TopicPlanGenerator.make(
                    ...
                    mkProducerGenerator = _ =>
                        ProducerPlanGenerator.make(
                            mkMessage =
                                _ => _ => Message(int64ToBytes(faker.random.nextLong(Long.MinValue, Long.MaxValue)))
                        ),
                    mkSchemaInfos = mkSchemaInfos
                )
            ) ++ getHighLoadTopics
