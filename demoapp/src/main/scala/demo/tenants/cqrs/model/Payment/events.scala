...
case class PaymentMethodAuthorized(
    paymentId: UUID,
...
case class PaymentMethodDenied(
    paymentId: UUID,
    paymentMethodId: UUID,
    transactionId: UUID,
    status: String,
...
case class PaymentMethodRefunded(
    paymentId: UUID,
    paymentMethodId: UUID,
    transactionId: UUID,
    status: String,
...
case class PaymentMethodRefundDenied(
    paymentId: UUID,
    paymentMethodId: UUID,
    transactionId: UUID,
    status: String,
...
object PaymentMethodRefundDenied
    extends Randomizable[PaymentMethodRefundDenied]
    with Schemable[PaymentMethodRefundDenied]:
...
case class PaymentMethodCancellationDenied(
    paymentId: UUID,
    paymentMethodId: UUID,
    transactionId: UUID,
    status: String,
...
object PaymentMethodCancellationDenied
    extends Randomizable[PaymentMethodCancellationDenied]
    with Schemable[PaymentMethodCancellationDenied]:
...
case class PaymentMethodCanceled(
    paymentId: UUID,
    paymentMethodId: UUID,
    transactionId: UUID,
    status: String,
...
case class PayPalAdded(cartId: UUID, methodId: UUID, amount: Money, payPal: PayPal, status: String, version: Long)
    extends Event
