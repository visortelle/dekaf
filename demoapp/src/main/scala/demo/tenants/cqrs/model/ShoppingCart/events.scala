...
case class CreditCardAdded(cartId: UUID, methodId: UUID, amount: Money, creditCard: CreditCard, version: Long)
    extends Event
...
case class DebitCardAdded(cartId: UUID, methodId: UUID, amount: Money, debitCard: DebitCard, version: Long)
    extends Event
