...
import demo.tenants.cqrs.model.Dto.NotificationMethod
...
case class RegisterUser(userId: UUID, firstName: String, lastName: String, email: String, password: String)
    extends Command
