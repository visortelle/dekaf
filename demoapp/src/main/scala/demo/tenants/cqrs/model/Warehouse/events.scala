...
case class InventoryItemReceived(
    inventoryId: UUID,
    itemId: UUID,
    product: Product,
    cost: BigDecimal,
...
case class InventoryAdjustmentIncreased(inventoryId: UUID, itemId: UUID, reason: String, quantity: Int, version: Long)
    extends Event

object InventoryAdjustmentIncreased
    extends Randomizable[InventoryAdjustmentIncreased]
    with Schemable[InventoryAdjustmentIncreased]:
...
case class InventoryAdjustmentDecreased(inventoryId: UUID, itemId: UUID, reason: String, quantity: Int, version: Long)
    extends Event

object InventoryAdjustmentDecreased
    extends Randomizable[InventoryAdjustmentDecreased]
    with Schemable[InventoryAdjustmentDecreased]:
...
case class InventoryAdjustmentNotDecreased(
    inventoryId: UUID,
    itemId: UUID,
    reason: String,
    quantityDesired: Int,
...
object InventoryAdjustmentNotDecreased
    extends Randomizable[InventoryAdjustmentNotDecreased]
    with Schemable[InventoryAdjustmentNotDecreased]:
...
case class InventoryItemNotReserved(
    inventoryId: UUID,
    itemId: UUID,
    cartId: UUID,
    quantityDesired: Int,
