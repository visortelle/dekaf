...
object CatalogNamespace:
  ...
  val catalogIdsMap = ConcurrentLinkedHashMap.Builder[UUID, Unit]()
    .maximumWeightedCapacity(10000)
    .build()

  val itemIdsMap = ConcurrentLinkedHashMap.Builder[UUID, Unit]()
    .maximumWeightedCapacity(10000)
    .build()
  ...
  def mkPlanGenerator(tenantName: TenantName) =
    ...
    val producerCommandsPlanGenerators = List(
      ...
      ProducerPlanGenerator.make(
        ...
        mkMessage = _ => _ =>
          mkMessageWithRandomKeyFromMap[pb.CatalogCommandsSchema](catalogIdsMap, randomCatalogId => {
            val activateCatalogPb = pb.ActivateCatalog.newBuilder()
              .setCatalogId(randomCatalogId.toString)

            pb.CatalogCommandsSchema.newBuilder()
      ...
      ProducerPlanGenerator.make(
        ...
        mkMessage = _ => _ =>
          mkMessageWithRandomKeyFromMap[pb.CatalogCommandsSchema](catalogIdsMap, randomCatalogId => {
            val addCatalogItem = model.Message.random[AddCatalogItem].copy(catalogId = randomCatalogId)
            ...
            val unitPrice = pbDto.Money.newBuilder()
      ...
      ProducerPlanGenerator.make(
        ...
        mkMessage = _ => _ =>
          mkMessageWithRandomKeyFromMap[pb.CatalogCommandsSchema](catalogIdsMap, randomCatalogId => {
            val changeCatalogDescription = model.Message.random[ChangeCatalogDescription].copy(catalogId = randomCatalogId)

            val changeCatalogDescriptionPb = pb.ChangeCatalogDescription.newBuilder()
      ...
      ProducerPlanGenerator.make(
        ...
        mkMessage = _ => _ =>
          mkMessageWithRandomKeyFromMap[pb.CatalogCommandsSchema](catalogIdsMap, randomCatalogId => {
            val changeCatalogTitle = model.Message.random[ChangeCatalogTitle].copy(catalogId = randomCatalogId)

            val changeCatalogTitlePb = pb.ChangeCatalogTitle.newBuilder()
      ...
      ProducerPlanGenerator.make(
        ...
        mkMessage = _ => _ =>
          mkMessageWithRandomKeyFromMap[pb.CatalogCommandsSchema](catalogIdsMap, randomCatalogId => {
            val deactivateCatalogPb = pb.DeactivateCatalog.newBuilder()
              .setCatalogId(randomCatalogId.toString)
      ...
      ProducerPlanGenerator.make(
        ...
        mkMessage = _ => _ =>
          mkMessageWithRandomKeyFromMap[pb.CatalogCommandsSchema](catalogIdsMap, randomCatalogId => {
            val deleteCatalogPb = pb.DeleteCatalog.newBuilder()
              .setCatalogId(randomCatalogId.toString)
      ...
      ProducerPlanGenerator.make(
        ...
        mkMessage = _ => _ =>
          mkMessageWithRandomKeyFromMap[pb.CatalogCommandsSchema](catalogIdsMap, randomCatalogId => {
            val removeCatalogItem = model.Message.random[RemoveCatalogItem].copy(catalogId = randomCatalogId)

            val removeCatalogItemPb = pb.RemoveCatalogItem.newBuilder()
    ...
    val producerEventsPlanGenerators = List(
      ProducerPlanGenerator.make(
        ...
        mkMessage = _ => _ =>
          mkMessageWithRandomKeyFromMap[pb.CatalogEventsSchema](catalogIdsMap, randomCatalogId => {
            val catalogItemIncreased = model.Message.random[CatalogItemIncreased].copy(catalogId = randomCatalogId)
