...
describe("memoryToBytes", () => {
  it("should convert memory size to bytes", () => {
    expect(memorySizeToBytes({ size: 0, unit: "M" })).toBeCloseTo(0);
    expect(memorySizeToBytes({ size: 1, unit: "M" })).toBeCloseTo(1024 * 1024);
    expect(memorySizeToBytes({ size: 2, unit: "M" })).toBeCloseTo(
      1024 * 1024 * 2
    );
    expect(memorySizeToBytes({ size: 2.2, unit: "M" })).toBeCloseTo(
      1024 * 1024 * 2.2
    );

    expect(memorySizeToBytes({ size: 1, unit: "G" })).toBeCloseTo(
      1024 * 1024 * 1024
    );
  });
});
