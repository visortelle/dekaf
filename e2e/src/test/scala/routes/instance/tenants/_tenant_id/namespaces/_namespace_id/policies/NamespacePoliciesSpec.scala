package routes.instance.tenants._tenant_id.namespaces._namespace_id.policies
...
val faker = new Faker()
object NamespacePoliciesSpec extends ZIOSpecDefault:
    def spec: Spec[Any, Any] = suite("Namespace policies page")(
        suite("Edit namespace properties")(
            test("User can create properties") {
                ...
                createProperty.addPropertyButton.click()
