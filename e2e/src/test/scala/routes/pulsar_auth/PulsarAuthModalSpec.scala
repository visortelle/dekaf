...
import routes.pulsar_auth.PulsarAuthModal
...
object PulsarAuthModalSpec extends ZIOSpecDefault:
    def spec: Spec[Any, Any] = suite("Pulsar auth module")(
        suite("Functionality") (
    ...
    def createOauth2Credentials(pulsarAuthModal: PulsarAuthModal,
        ...
        pulsarAuthModal.setOAuthCredentialsPrivateKeyFile("auth/default_oauth2_private_key.json")
