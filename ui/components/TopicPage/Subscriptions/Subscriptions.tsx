    ...
    <div className={s.Subscriptions}>
      <Table<ColumnKey, DataEntry, {}>
        columns={{
          ...
          defaultConfig: [
            { columnKey: "subscriptionName", width: 300, visibility: 'visible', stickyTo: 'left' },
            { columnKey: "type", width: 80, visibility: 'visible' },
            { columnKey: "isDurable", width: 80, visibility: 'visible' },
            { columnKey: "consumersCount", width: 80, visibility: 'visible' },
            { columnKey: "activeConsumerName", width: 300, visibility: 'visible' },
            { columnKey: "msgRateOut", width: 120, visibility: 'visible' },
            { columnKey: "msgThroughputOut", width: 120, visibility: 'visible' },
            { columnKey: "bytesOutCounter", width: 120, visibility: 'visible' },
            { columnKey: "msgOutCounter", width: 120, visibility: 'visible' },
            { columnKey: "msgRateRedeliver", width: 120, visibility: 'visible' },
            { columnKey: "messageAckRate", width: 120, visibility: 'visible' },
            { columnKey: "chunkedMessageRate", width: 120, visibility: 'visible' },
            { columnKey: "msgBacklog", width: 200, visibility: 'visible' },
            { columnKey: "backlogSize", width: 200, visibility: 'visible' },
            { columnKey: "earliestMsgPublishTimeInBacklog", width: 200, visibility: 'visible' },
            { columnKey: "msgBacklogNoDelayed", width: 200, visibility: 'visible' },
            { columnKey: "isBlockedSubscriptionOnUnackedMsgs", width: 200, visibility: 'visible' },
            { columnKey: "msgDelayed", width: 200, visibility: 'visible' },
            { columnKey: "unackedMessages", width: 200, visibility: 'visible' },
            { columnKey: "msgRateExpired", width: 200, visibility: 'visible' },
            { columnKey: "totalMsgExpired", width: 200, visibility: 'visible' },
            { columnKey: "lastExpireTimestamp", width: 200, visibility: 'visible' },
            ...
            { columnKey: "lastMarkDeleteAdvancedTimestamp", width: 200, visibility: 'visible' },
            { columnKey: "isReplicated", width: 200, visibility: 'visible' },
            { columnKey: "isAllowOutOfOrderDelivery", width: 200, visibility: 'visible' },
            { columnKey: "keySharedMode", width: 200, visibility: 'visible' },
            { columnKey: "consumersAfterMarkDeletePosition", width: 200, visibility: 'visible' },
            { columnKey: "subscriptionProperties", width: 200, visibility: 'visible' },
            { columnKey: "nonContiguousDeletedMessagesRanges", width: 200, visibility: 'visible' },
            { columnKey: "nonContiguousDeletedMessagesRangesSerializedSize", width: 200, visibility: 'visible' },
            { columnKey: "filterProcessedMsgCount", width: 200, visibility: 'visible' },
            { columnKey: "filterAcceptedMsgCount", width: 200, visibility: 'visible' },
            { columnKey: "filterRejectedMsgCount", width: 200, visibility: 'visible' },
            { columnKey: "filterRescheduledMsgCount", width: 200, visibility: 'visible' },
            { columnKey: "delayedMessageIndexSizeInBytes", width: 200, visibility: 'visible' }
          ],
        }}
        dataLoader={{
