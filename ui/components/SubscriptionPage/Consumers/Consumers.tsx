    ...
    <div className={s.Page}>
      <Table<ColumnKey, DataEntry, {}>
        columns={{
          ...
          defaultConfig: [
            { key: 'consumerName', width: 300, visibility: 'visible', stickyTo: 'left' },
            { key: 'msgRateOut', width: 100, visibility: 'visible' },
            { key: 'msgThroughputOut', width: 100, visibility: 'visible' },
            { key: 'bytesOutCounter', width: 100, visibility: 'visible' },
            { key: 'msgRateRedeliver', width: 100, visibility: 'visible' },
            { key: 'messageAckRate', width: 100, visibility: 'visible' },
            { key: 'chunkedMessageRate', width: 100, visibility: 'visible' },
            { key: 'availablePermits', width: 100, visibility: 'visible' },
            { key: 'unackedMessages', width: 100, visibility: 'visible' },
            { key: 'avgMessagesPerEntry', width: 100, visibility: 'visible' },
            { key: 'isBlockedConsumerOnUnackedMsgs', width: 100, visibility: 'visible' },
            { key: 'readPositionWhenJoining', width: 100, visibility: 'visible' },
            ...
            { key: 'keyHashRanges', width: 200, visibility: 'visible' },
