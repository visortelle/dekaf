// Source: https://github.com/revin/markdown-it-task-lists/blob/master/index.js
...
function isInline(token: any) { return token.type === 'inline'; }
function isParagraph(token: any) { return token.type === 'paragraph_open'; }
function isListItem(token: any) { return token.type === 'list_item_open'; }
