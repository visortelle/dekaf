...
const field = (props: FieldInputProps): ConfigurationField => ({
  ...
  description: <span>Max unacked messages per consumer. If the unacked messages exceed a threshold then the consumer gets blocked, as described by setting <code>blockedConsumerOnUnackedMsgs</code> to true</span>,
