...
def mergeConfigs(lowPriority: Config, highPriority: Config): Config =
    Config(
        ...
        pulsarInstanceName = highPriority.pulsarInstanceName.orElse(lowPriority.pulsarInstanceName),
        pulsarInstanceColor = highPriority.pulsarInstanceColor.orElse(lowPriority.pulsarInstanceColor),
