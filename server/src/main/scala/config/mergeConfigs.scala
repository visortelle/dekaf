...
def mergeConfigs(lowPriority: Config, highPriority: Config): Config =
    Config(
        ...
        protocol = highPriority.protocol.orElse(lowPriority.protocol),
        tlsCertificateFilePath = highPriority.tlsCertificateFilePath.orElse(lowPriority.tlsCertificateFilePath),
        tlsKeyFilePath = highPriority.tlsKeyFilePath.orElse(lowPriority.tlsKeyFilePath),
