...
object DateTimeGenerator:
    def fromPb(v: pb.DateTimeGenerator): DateTimeGenerator =
        val generator = v.generator match
            ...
            case pb.DateTimeGenerator.Generator.GeneratorFromJsonMillisOrIso(v)  => JsonGenerator.fromPb(v)
    ...
    def toPb(v: DateTimeGenerator): pb.DateTimeGenerator =
        val generator = v.generator match
            ...
            case v: JsonGenerator           => pb.DateTimeGenerator.Generator.GeneratorFromJsonMillisOrIso(JsonGenerator.toPb(v))
