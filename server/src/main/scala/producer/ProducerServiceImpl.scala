...
class ProducerServiceImpl extends pb.ProducerServiceGrpc.ProducerService:
    ...
    override def createProducerSession(request: pb.CreateProducerSessionRequest): Future[pb.CreateProducerSessionResponse] = ???
    override def deleteProducerSession(request: pb.DeleteProducerSessionRequest): Future[pb.DeleteProducerSessionResponse] = ???
    override def getProducerSessionStats(request: pb.GetProducerSessionStatsRequest): Future[pb.GetProducerSessionStatsResponse] = ???
    override def pauseProducerSession(request: pb.PauseProducerSessionRequest): Future[pb.PauseProducerSessionResponse] = ???
    override def resumeProducerSession(request: pb.ResumeProducerSessionRequest): Future[pb.ResumeProducerSessionResponse] = ???
