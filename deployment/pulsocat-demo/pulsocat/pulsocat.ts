    ...
    values: {
      ...
      pulsocat: {
        ...
        env: [
          ...
          { name: "PULSOCAT_PULSAR_INSTANCE_BROKER_SERVICE_URL", value: "pulsar+ssl://cluster-d.o-xy6ek.snio.cloud:6651" },
          { name: "PULSOCAT_PULSAR_INSTANCE_WEB_SERVICE_URL", value: "https://cluster-d.o-xy6ek.snio.cloud" },
        ]
      }
    }
  }, {
